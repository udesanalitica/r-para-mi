...
Este documento explica qué tipo de aportes se buscan, cómo enviarlos y bajo qué condiciones se incorporan, con especial atención a la reproducibilidad y a la procedencia de datos e imágenes de microbiología industrial.
...
**Figuras e imágenes.** No se admiten figuras, diagramas, fotografías ni capturas tomadas de libros, artículos o sitios web, aunque estén citados correctamente. Citar la fuente evita el plagio, pero no otorga permiso de reproducción, y se proyecta publicar el material bajo un esquema de licenciamiento abierto; mientras ese proceso se formaliza, cualquier reutilización debe respetar las condiciones institucionales vigentes.
...
Al enviar una contribución, quien la aporta acepta que, una vez formalizado el esquema institucional, pueda publicarse bajo las licencias previstas para el proyecto: **CC BY-SA 4.0** para el texto y las figuras propias, y **licencia MIT** para el código.
...
Para dudas que no encajen en un *issue*: coordinador.analitica\@udes.edu.co
