...
El **Diseño Completamente al Azar** se emplea cuando los tratamientos se asignan aleatoriamente a las unidades experimentales, sin ningún tipo de restricción o agrupamiento. El modelo lineal aditivo general se expresa como:
...
![Nota: Dilución de conidios y sustrato, en solución tween80® 0,01%: Avena (A); Arroz (B); Cebada (C); Maíz Partido (D).](images/3_DCA/sustrato.png){fig-alt="Figura 1." width="503"}
