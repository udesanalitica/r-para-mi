...
![Nota. Mapa conceptual (p. 51). Gutiérrez Pulido, H., y De la Vara Salazar, R. (2012). Análisis y diseño de experimentos (3ª ed.). McGraw-Hill/Interamericana de México. ISBN: 9786071507259.](images/3_DCA/DCA.PNG)

El mapa conceptual organiza los elementos fundamentales de los **experimentos con un solo factor**. De este tipo de diseños se desprende el **Diseño Completamente al Azar (DCA)**, que utiliza herramientas como el **ANOVA**, los **diagramas de cajas** y las **gráficas de medias** para analizar las diferencias entre tratamientos.
...
El **Diseño Completamente al Azar (DCA)** se utiliza cuando las unidades experimentales son homogéneas y los tratamientos se asignan completamente al azar, sin ningún tipo de agrupación o bloqueo. El modelo lineal aditivo general se expresa como:
...
![Nota: Dilución de conidios y sustrato, en solución tween80® 0,01%: Avena (A); Arroz (B); Cebada (C); Maíz Partido (D).](images/3_DCA/sustrato.png){width="503"}

\
La evaluación in vitro reveló que las concentraciones de extracto crudo de 4,0 al 6,0% generaron Porcentajes de Inhibición del Crecimiento micelial (PICM) del 40 al 50 % respectivamente al quinto día después de la inoculación (ddi).
...
\
Por otro lado, los ensayos in vivo evidenciaron una mayor eficacia del extracto crudo, donde las concentraciones de 8, 9, 10, 11, 12 y 13% generaron porcentajes de inhibición del área de la lesión (PIAL) de 60, 55, 70, 72, 77 y 80% respectivamente, sugiriendo que Penicillium digitatum podría representar una alternativa viable para el manejo preventivo de la antracnosis del banano.

Efecto in vivo de bananos infectados con *Colletotrichum musae* en los tratamientos.

![Nota: Experimento in vivo de los bananos infectados con 107 conidios de Colletotrichum musae, frente a tratamientos (A los 7 días de la inoculación). (A) Testigo negativo; (B) Azoxystrobin (Testigo positivo); Extractos de Penicillium sp. a (C) 8%; (D) 9%; (E) 10%; (F) 11%; (G) 12%; (H) 13%.](images/3_DCA/experimentobananos.png){width="584"}
...
::: callout-tip
**Antes e inciar:** R lee / (slash o division) y no el de Windows \\
