...
**Indica que los valores de una observación no deben depender de los de otra. Este supuesto se evalúa mediante el **test de Durbin--Watson**, que analiza la posible autocorrelación de los residuos. Valores de *p* mayores a 0.05 sugieren independencia, condición necesaria para la validez del modelo.
